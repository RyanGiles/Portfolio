    ...
    <div className="contact">
      ...
      <div className="contact__info">
        ...
        <div className="contact__block contact__desc">
          ...
          SCAD (Savannah College of Art and Design) set to graduate in May '26.
          Before going to SCAD, I spent 2 years studying Computer Science at
          Texas A&M University. I also recieved a Software Development Diploma
          from Brainstation Coding Bootcamp, where I learned to design and
          program websites using HTML, CSS, and React.js <br />
          <br />
        ...
        <form action="submit" className="contact__block contact__form"></form>
      </div>
    </div>
  );
}
